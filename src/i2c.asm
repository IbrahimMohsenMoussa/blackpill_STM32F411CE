...
wait_sb
    ...
    ldr     r1, [r4, #I2C_SR1]
    tst     r1, #I2C_SR1_AF      ; Check if previous queued byte caused a NACK
    bne     i2c_start_nack       ; Abort to prevent hang
    tst     r1, #I2C_SR1_SB
    beq     wait_sb
...
i2c_start_nack
    ...
    ; Force STOP immediately instead of calling I2C1_Stop (which hangs waiting for BTF)
    ldr     r1, [r4, #I2C_CR1]
...
wait_rxne_nack
    ...
    ; 3. Generate STOP before reading the last byte to prevent extra clocks
    ldr     r1, [r4, #I2C_CR1]
    orr     r1, r1, #I2C_CR1_STOP
    str     r1, [r4, #I2C_CR1]
